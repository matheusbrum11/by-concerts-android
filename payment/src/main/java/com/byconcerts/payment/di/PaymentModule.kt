...
/**
 * Grafo Koin do módulo de pagamento. As credenciais vêm de BuildConfig (lido do
 * local.properties). O barramento de callback é singleton para ser compartilhado
 * entre o gateway (que aguarda) e a PaymentResponseActivity (que publica).
 */
